...
__attribute__((__noinline__)) static char *longlong_to_string(char *buf, unsigned long long n, size_t len, uint flag, char *signchar)
{
    size_t pos = len;
    int negative = 0;
...
__attribute__((__noinline__)) static char *longlong_to_hexstring(char *buf, unsigned long long u, size_t len, uint flag)
{
    size_t pos = len;
...
__attribute__((__noinline__)) static size_t exponent_to_string(char *buf, int32_t exponent)
{
    size_t pos = 0;
...
__attribute__((__noinline__)) static char *double_to_string(char *buf, size_t len, double d, uint flag)
{
    size_t pos = 0;
...
__attribute__((__noinline__)) static char *double_to_hexstring(char *buf, size_t len, double d, uint flag)
{
    size_t pos = 0;
    union double_int u = { d };
...
{
    return vsnprintf(str, 2147483647, fmt, ap);
}
